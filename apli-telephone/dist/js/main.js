    ...
    _createClass(Chatbot, [{
        ...
        value: function bindEvents() {
            ...
            this.$button.addEventListener("click", function () {
                if (_this.isopen) {
                    _this.isopen = false;
                    _this.$chatbot.classList.add("hide");
                } else {
                    _this.isopen = true;
                    _this.$chatbot.classList.remove("hide");
                }
            });
        }
    }]);
...
var DataPerso = function () {
    function DataPerso() {
        _classCallCheck(this, DataPerso);

        this.$bpm = document.querySelector(".bpm");
        setInterval(function () {
            var bp = Math.floor(Math.random() * 60 + 60);
            document.querySelector(".bpm").innerHTML = bp;
            _jquery2.default.post("http://51.68.87.119:8080/bpm", { "value": bp }, function (data) {
                console.log(data);
            });
        }, 1000);
        this.bindEvents();
...
var Distance = function () {
    ...
    _createClass(Distance, [{
        ...
        key: "requete",
        value: function requete() {

            $.post('https://www.googleapis.com/fitness/v1/users/me/dataset:aggregate', // Le fichier cible côté serveur.
            {
                "aggregateBy": [{
        ...
        key: "retour",
        value: function retour(texte_recu) {
...
var News = function () {
    function News() {
        ...
        setInterval(function () {
            if (verifMort == true) {
                _jquery2.default.post("http://51.68.87.119:8080/message", { "message": "ALERT IL EST MORT" }, function (data) {
                    console.log(data);
                });
    ...
    _createClass(News, [{
        ...
        value: function bindEvents() {
            this.$button.addEventListener("click", function () {
                ...
                _jquery2.default.post("http://51.68.87.119:8080/message", { "message": this.news }, function (data) {
                    console.log(data);
                });
                this.$envoieNews.style.opacity = '0';
                verifMort = false;
...
var _DataPerso = require('./components/DataPerso');

var _DataPerso2 = _interopRequireDefault(_DataPerso);

var _ChatBot = require('./components/ChatBot');

var _ChatBot2 = _interopRequireDefault(_ChatBot);

var _Distance = require('./components/Distance');
...
var App = {
    ...
    ready: function ready() {
        ...
        //new Distance();
        new _News2.default();
        new _DataPerso2.default();
        new _ChatBot2.default();
    },
...
},{"./components/Acceleration":3,"./components/ChatBot":4,"./components/DataPerso":5,"./components/Distance":6,"./components/Example":7,"./components/News":8,"./utils/environment":10}],10:[function(require,module,exports){
'use strict';
